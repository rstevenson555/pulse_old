...
public class ViewDailyPageLoadTimesHelper {
    ...
    private Element appendDailyPageSummaryElement(
        ...
        try {
            ...
            Query query = session.createQuery("from DailyPageLoadTimBean as dpltb where dpltb.day=:day");
            query.setParameter("day", selectedDate);
            query.setMaxResults(500);
            List dailyPageSummaryList2 = query.list();
