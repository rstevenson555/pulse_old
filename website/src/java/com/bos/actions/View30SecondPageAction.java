...
import com.bos.helper.View30SecondPageHelper;

/**
 * This action class is used for the Main screen.<Br>
 */

public class View30SecondPageAction extends BaseAction {

	static {
		logger =
			(Logger) Logger.getLogger(View30SecondPageAction.class.getName());
	}
	...
	HttpServletResponse response) {
		...
		View30SecondPageHelper mh = null;
        ...
        if(selectedDate != null && !selectedDate.equals("")) {
        	...
        	mh = new View30SecondPageHelper(s2.toString(),page);
        } else {
        	...
        	mh = new View30SecondPageHelper(dateString,page);
        }
