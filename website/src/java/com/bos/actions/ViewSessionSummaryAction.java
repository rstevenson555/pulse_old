...
import com.bos.helper.SessionsSummaryChartsHelper;

/**
 * This action class is used for the Main screen.<Br>
 */

public class ViewSessionSummaryAction extends BaseAction {

	static {
		logger =
			(Logger) Logger.getLogger(ViewSessionSummaryAction.class.getName());
	}
	...
	HttpServletResponse response) {
        ...
        SessionsSummaryChartsHelper mh = null;
        ...
        if(selectedDate != null && !selectedDate.equals("")) {
        	...
        	mh = new SessionsSummaryChartsHelper(s2.toString());
        } else {
        	...
        	mh = new SessionsSummaryChartsHelper(dateString);
        }
