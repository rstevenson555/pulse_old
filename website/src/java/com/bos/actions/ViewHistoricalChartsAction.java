...
public class ViewHistoricalChartsAction extends BaseAction {

	static {
		logger =
			(Logger) Logger.getLogger(ViewHistoricalChartsAction.class.getName());
	}
	...
	HttpServletResponse response) {
        ...
        ViewHistoricalChartsHelper mh = null;
        ...
        if(selectedDate != null && !selectedDate.equals("")) {
        	...
        	mh = new ViewHistoricalChartsHelper(s2.toString());
        } else {
        	...
        	mh = new ViewHistoricalChartsHelper(dateString);
        }
