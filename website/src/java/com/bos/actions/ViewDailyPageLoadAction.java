...
import com.bos.helper.ViewDailyPageLoadTimesHelper;
...
public class ViewDailyPageLoadAction extends BaseAction {

	static {
		logger =
			(Logger) Logger.getLogger(ViewDailyPageLoadAction.class.getName());
	}
	...
	HttpServletResponse response) {
        ...
        ViewDailyPageLoadTimesHelper mh = null;
        ...
        if(selectedDate != null && !selectedDate.equals("")) {
        	...
        	StringBuffer s2 = b2.insert(7,'-');
         	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                try {
                    Date d = sdf.parse(b2.toString());
                    System.out.println("ViewDailyPageLoadAction date: "+ d);
        	
        	    mh = new ViewDailyPageLoadTimesHelper(d);
                }
                catch(Exception e)
                {
