...
public class ViewTimeSliceDetailAction extends BaseAction {

	static {
		logger =
			(Logger) Logger.getLogger(ViewTimeSliceDetailAction.class.getName());
	}
	...
	HttpServletResponse response) {
        ...
        if(selectedDate != null && !selectedDate.equals("")) {
        	...
        	mh = new TimeSliceDetailReport(s2.toString(),startTime, endTime, contextQuery, pageQuery);
        } else {
        	...
        	mh = new TimeSliceDetailReport(dateString,startTime, endTime, contextQuery, pageQuery);
        }
