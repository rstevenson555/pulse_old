...
public class ViewMinuteStatTimeSliceGraphAction extends BaseAction {

	public static final String GRAPH="JFreeGraph";
	static {
		logger =
			(Logger) Logger.getLogger(ViewMinuteStatTimeSliceGraphAction.class.getName());
	}
	...
	HttpServletResponse response) {
        ...
        request.setAttribute(GRAPH, cgh.generateMinuteStatsReport(title,ALL_MACHINES,startTime,endTime));
