...
import com.bos.helper.ViewExceptionDetailHelper;
...
public class ViewExceptionDetailAction extends BaseAction {

	static {
		logger =
			(Logger) Logger.getLogger(ViewExceptionDetailAction.class.getName());
	}
...
//         	todaysDate.append(calendar.get(Calendar.YEAR));
        	...
        	mh = new ViewExceptionDetailHelper(dateString,el,eid);
        }
