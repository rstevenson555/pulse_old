...
import com.bos.helper.ViewCurrentDeploymentsHelper;

/**
 * This action class is used for the Main screen.<Br>
 */

public class ViewCurrentDeploymentsAction extends BaseAction {

	static {
		logger =
			(Logger) Logger.getLogger(ViewCurrentDeploymentsAction.class.getName());
	}
	...
	HttpServletResponse response) {
		...
		ViewCurrentDeploymentsHelper mh = null;
		...
		if(selectedDate != null && !selectedDate.equals("")) {
					...
					StringBuffer s2 = b2.insert(7,'-');
         			mh = new ViewCurrentDeploymentsHelper(s2.toString());
					...
					String dateString = sdf.format(d);
         			...
         			mh = new ViewCurrentDeploymentsHelper(dateString);
				}
