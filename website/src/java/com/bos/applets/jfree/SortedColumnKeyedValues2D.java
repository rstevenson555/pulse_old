 ...
 *
 * -------------------------
 * SortedColumnKeyedValues2D.java
 * -------------------------
 ...
 */
public class SortedColumnKeyedValues2D implements KeyedValues2D, PublicCloneable,
     ...
     */
    public SortedColumnKeyedValues2D() {
        this(false);
    }
     ...
     */
    public SortedColumnKeyedValues2D(boolean sortRowKeys) {
     ...
     * throw an {@link org.jfree.data.UnknownKeyException} if either key is not defined in the
     * data structure.
     *
     ...
     *
     * @throws org.jfree.data.UnknownKeyException if <code>rowKey</code> is not defined in the
     *         table.
     */
     ...
     * @param columnKey  the column key (<code>null</code> not permitted).
     *
     * @throws org.jfree.data.UnknownKeyException if the table does not contain a column with
     *     the specified key.
    ...
    public Object clone() throws CloneNotSupportedException {
        SortedColumnKeyedValues2D clone = (SortedColumnKeyedValues2D) super.clone();
