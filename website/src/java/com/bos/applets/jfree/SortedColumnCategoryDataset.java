 ...
 *
 * ---------------------------
 * SortedColumnCategoryDataset.java
 * ---------------------------
 ...
 * Changes
 * -------
 * 21-Jan-2003 : Added standard header, and renamed SortedColumnCategoryDataset (DG);
...
/**
 * A default implementation of the {@link org.jfree.data.category.CategoryDataset} interface.
 */
public class SortedColumnCategoryDataset extends AbstractDataset
    ...
    private SortedColumnKeyedValues2D data;

    /**
     * Creates a new (empty) dataset.
     */
    public SortedColumnCategoryDataset() {
        this.data = new SortedColumnKeyedValues2D();
    }
    ...
    /**
     * Removes a value from the dataset and sends a {@link org.jfree.data.general.DatasetChangeEvent}
    ...
    /**
     * Removes a row from the dataset and sends a {@link org.jfree.data.general.DatasetChangeEvent}
     * to all registered listeners.
     *
    ...
    /**
     * Removes a column from the dataset and sends a {@link org.jfree.data.general.DatasetChangeEvent}
     * to all registered listeners.
     *
     ...
     *
     * @throws org.jfree.data.UnknownKeyException if <code>columnKey</code> is not defined
     *         in the dataset.
     */
    ...
    /**
     * Clears all data from the dataset and sends a {@link org.jfree.data.general.DatasetChangeEvent}
     * to all registered listeners.
     */
    public void clear() {
        this.data.clear();
    ...
    public Object clone() throws CloneNotSupportedException {
        SortedColumnCategoryDataset clone = (SortedColumnCategoryDataset) super.clone();
        clone.data = (SortedColumnKeyedValues2D) this.data.clone();
        return clone;
    }
