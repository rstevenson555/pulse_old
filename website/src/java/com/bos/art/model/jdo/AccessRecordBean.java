...
public class AccessRecordBean implements Serializable {
    ...
    /** minimal constructor */
    public AccessRecordBean(Integer recordPk, com.bos.art.model.jdo.SessionBean session, com.bos.art.model.jdo.AppBean app, com.bos.art.model.jdo.ContextBean context, com.bos.art.model.jdo.MachinBean machin, com.bos.art.model.jdo.PagBean pag, com.bos.art.model.jdo.UserBean user) {
        this.recordPk = recordPk;
        this.session = session;
        this.app = app;
        this.context = context;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof AccessRecordBean) ) return false;
        AccessRecordBean castOther = (AccessRecordBean) other;
