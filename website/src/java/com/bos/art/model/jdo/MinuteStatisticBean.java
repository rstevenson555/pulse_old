...
public class MinuteStatisticBean implements Serializable {
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof MinuteStatisticBean) ) return false;
        MinuteStatisticBean castOther = (MinuteStatisticBean) other;
