...
class AccessRecordsCleaner
    ...
    def restart
        ...
        record = @artdb.execute_prepared_query("select a.maxRPK as max_rpk , b.minRPK  as min_rpk, a.maxRPK - b.minRPK as diff from 
                    ...
                    (select recordpk as minRPK from AccessRecords order by recordpk asc limit 1) b limit 1",AccessRecords,{:concurrent=>true,:all=>true,:autocommit=>false,:fetchsize=>500,:queuesize=>1000})
