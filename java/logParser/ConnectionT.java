    ...
    */
    ...
    static{
        if(LPConstants.Database.equalsIgnoreCase("MySQL")){
            ...
            sqlAddSession = "INSERT INTO Sessions (Session_ID, sessionTXT, IPAddress, User_id) "+
...
public static void main(String args[]){
   ...
   public static String[] getForiegnKeys2(jspErrorObject jeo, Connection con) throws SQLException, NumberFormatException {
        ...
        if(SessionNo == null)
        {
            ...
            SessionNo = getSession(fullsession,sip, browser,UserNo.intValue(), con);
        }
        else 
...
//        rs = stmt.executeQuery("SELECT * FROM Pages Where PageName='"+page.trim()+"'");
    ...
    public static Integer getSession(String fullsession, String sip, String browsertype, int luser_id, Connection con){
        ++idblookupSessions;
