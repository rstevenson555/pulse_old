...
public class LiveLogPriorityQueue implements Serializable {
    ...
    private Disruptor<ObjectEvent> disruptor = new Disruptor<ObjectEvent>(ObjectEvent.FACTORY, 256, executor,
            ProducerType.SINGLE, new BlockingWaitStrategy());

    private static BasicThreadFactory disruptorThreadFactory = new BasicThreadFactory.Builder()
    ...
    * disruptor end
    ...
    private class DatabaseWriteQueueHandler implements Runnable {
        ...
        public void setRecord(Object t) {
            timing = (ILiveLogPriorityQueueMessage) t;
        }
