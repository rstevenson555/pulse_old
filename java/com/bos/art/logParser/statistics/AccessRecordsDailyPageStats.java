...
public class AccessRecordsDailyPageStats extends StatisticsUnit {
    ...
    private static MutableSingletonInstanceHelper instance = new MutableSingletonInstanceHelper<AccessRecordsDailyPageStats>(AccessRecordsDailyPageStats.class) {
        @Override
        public java.lang.Object createInstance() {
            return new AccessRecordsDailyPageStats();
        }
    };
    ...
    public static AccessRecordsDailyPageStats getInstance() {
        return (AccessRecordsDailyPageStats) instance.getInstance();
    }

    public void setInstance(StatisticsUnit su) {
        if (su instanceof AccessRecordsDailyPageStats) {
            if (instance.getInstance() != null) {
                ((AccessRecordsDailyPageStats) instance.getInstance()).setRunnable(false);
