...
public class AccessRecordsHourlyStats extends StatisticsUnit {
    ...
    private static MutableSingletonInstanceHelper instance = new MutableSingletonInstanceHelper<AccessRecordsHourlyStats>(AccessRecordsHourlyStats.class) {
        @Override
        public java.lang.Object createInstance() {
            return new AccessRecordsHourlyStats();
        }
    };
    ...
    public static AccessRecordsHourlyStats getInstance() {
        return (AccessRecordsHourlyStats) instance.getInstance();
    }

    public void setInstance(StatisticsUnit su) {
        if (su instanceof AccessRecordsHourlyStats) {
            if (instance.getInstance() != null) {
                ((AccessRecordsHourlyStats) instance.getInstance()).setRunnable(false);
            }
