...
public class AccumulatorDailyStats extends StatisticsUnit {
	...
	private static AccumulatorDailyStats instance;
	...
	//private static final SimpleDateFormat sdfzone = new SimpleDateFormat("yyyyMMdd HH:mm:ss zzz");
	...
	public static AccumulatorDailyStats getInstance(){
		if(instance == null){
			instance = new AccumulatorDailyStats();
		}
		return instance;
	}
	public void setInstance(StatisticsUnit su){
		if(su instanceof AccumulatorDailyStats){
			...
			instance = (AccumulatorDailyStats)su;
		}
	}
	...
	//static SimpleDateFormat mysql2= new SimpleDateFormat("yyyy-MM-dd 00:00:00");	
